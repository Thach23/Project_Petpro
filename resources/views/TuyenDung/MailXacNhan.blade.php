...
<body class="">
    <span class="preheader">From petpro team</span>
                            ...
                            <td class="wrapper">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <p>Dear customer,</p>
                                            <p>Thank you for apply our service, we pleasure to bring you
                                                the best quality product for you and your pet.</p>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td> <a href="{{ route('home') }}"
                                                                                target="_blank">Return to petpro</a>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                            ...
                                            {{-- <img src="{{ asset('/assets/images/bg-wave.svg') }}" alt=""> --}}
                                        </td>
                                    </tr>
                                </table>
                            </td>
